...
Resumo: https://creativecommons.org/licenses/by-nc-sa/4.0/deed.pt
Texto legal: https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode.pt

Em caso de divergência entre este arquivo e o texto publicado pela Creative Commons, prevalece o texto publicado.
...
Os pictogramas em `public/conteudo/arasaac/` são do ARASAAC, distribuídos sob CC BY-NC-SA, e estão incluídos sem modificação. Crédito exigido:
...
Em português: autor dos pictogramas Sergio Palao, origem ARASAAC, licença CC BY-NC-SA, propriedade do Governo de Aragão, Espanha.

A lista de arquivos, com o ID de cada pictograma, está em `public/conteudo/arasaac/CREDITOS.md`. Quem redistribuir o pacote precisa manter esse crédito e a mesma licença.

Pranchas, fotos, vozes e registros criados por quem usa o aplicativo pertencem a essa pessoa e não são cobertos por este arquivo.
